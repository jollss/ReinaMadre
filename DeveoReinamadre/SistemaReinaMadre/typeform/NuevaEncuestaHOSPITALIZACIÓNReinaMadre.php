...
date_default_timezone_set('America/Mexico_City');
   $hoy = date("Y-m-d H:i:s");
            ...
            $fecha_aterrizaje='fecha_servidor';
            $fecha_envio='fecha_envio';
            $idform='idform';
        $insert = "INSERT  into $preubadeid (";
        $insert.= implode(",",$idrespuesrtas);
        $insert.= ",$fecha_aterrizaje,$fecha_envio,$idform,fecha_real) values ('$a','$hoy','$landed_at','$preubadeid','$fechafinal')";
        echo $insert;
