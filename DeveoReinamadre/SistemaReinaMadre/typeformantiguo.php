     ...
     #total de area y rol un count -$total=$rolarea->num_rows;
       ...
       include('menu.php');?>
 		...
 		<div id="page-wrapper">
 			<div class="main-page">
 				<div class="forms">
 					<h2 class="title1">TypeForm Antiguo</h2>
 					<div class="form-grids row widget-shadow" data-example-id="basic-forms">
 						<div class="form-title">
 							<h4>Datos Typeform :</h4>
 						</div>
 						<div class="form-body">
 	<form>
                 <div class="form-group">
  <label for="exampleInputEDB">Nombre De Tu Base de Datos</label>
     <input type="text" class="form-control" id="exampleInputEDB" placeholder="Nuevos Clientes">
   </div>
   <div class="form-group">
     <label for="exampleInputPassword1">Agregar Campos DB</label>
