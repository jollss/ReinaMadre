...
VALUES
('$siteId','$appointmentId','$status','$isConfirmed','$hasArrived','$locationId','$clientId','$clientFirstName','$clientLastName','$clientEmail','$clientPhone','$staffId','$staffFirstName','$staffLastName','$fechastartDateTime','$fechaendDateTime',
