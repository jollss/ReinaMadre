...
if (isset($consultaBusqueda)) {
	...
	WHERE purchasingClientId='$consultaBusqueda' and payments='$consultaBusqueda1'");
	...
	if ($filas === 0) {
		$mensaje = "<H3>No hay ningún usuario con ese rfc y numero de tiket</H3>";
	} else {
			...
			<ul class="address">
							<li>
								<ul class="agileits-address-text ">
									<li class="agile-it-adress-left"><b>RFC</b></li>
									<li><span>:</span>'.$nombre.'</li>
								</ul>
							</li>
							<li>
								<ul class="agileits-address-text">
									<li class="agile-it-adress-left"><b>APELLIDOS</b></li>
									<li><span>:</span>'.$apellido.'</li>
								</ul>
							</li>
							<li>
								<ul class="agileits-address-text">
